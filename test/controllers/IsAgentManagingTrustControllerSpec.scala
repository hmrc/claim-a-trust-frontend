  ...
  "IsAgentManagingTrust Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) mustEqual
        view(form.fill(true), NormalMode, identifier)(request, messages).toString
    ...
    "send user to Relationship found" in {
      ...
      val application =
        applicationBuilder(userAnswers = Some(userAnswers), relationshipEstablishment = fakeEstablishmentServiceFound)
          .build()
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, NormalMode, identifier)(request, messages).toString
